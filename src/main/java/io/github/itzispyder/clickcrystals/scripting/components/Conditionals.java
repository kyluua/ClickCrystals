...
public class Conditionals implements Global {
    ...
    static {
        ...
        PLAYING = register("playing", ctx -> ctx.end(PlayerUtils.valid() && mc.gui.screen() == null));
        IN_SCREEN = register("in_screen", ctx -> ctx.end(PlayerUtils.valid() && mc.gui.screen() != null));
